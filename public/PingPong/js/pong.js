var Pong = function() {
  ...
  this.paddle1 = {
    x: 10,
    y: ch / 2 - _.paddleHeight / 2,
    w: _.paddleWidth,
    h: _.paddleHeight,
  };
  this.paddle2 = {
    x: cw - _.paddleWidth - 10,
    y: ch / 2 - _.paddleHeight / 2,
    w: _.paddleWidth,
    h: _.paddleHeight,
  };
  ...
  this.updateBallMovement = function() {
    ...
    if (
      _.ball.y > _.paddle1.y &&
      _.ball.y < _.paddle1.y + _.paddleHeight &&
      _.ball.x - _.ballRadius < _.paddle1.x + _.paddleWidth
    ) {
        WALL_HIT.play();
      _.ballXDir = 1;
    }
    if (
      _.ball.y > _.paddle2.y &&
      _.ball.y < _.paddle2.y + _.paddleHeight &&
      _.ball.x + _.ballRadius > _.paddle2.x
    ) {
        WALL_HIT.play();
      _.ballXDir = -1;
    }
